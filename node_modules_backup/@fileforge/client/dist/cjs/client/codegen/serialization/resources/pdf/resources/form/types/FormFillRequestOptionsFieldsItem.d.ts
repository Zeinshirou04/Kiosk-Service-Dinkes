...
export declare const FormFillRequestOptionsFieldsItem: core.serialization.Schema<serializers.pdf.FormFillRequestOptionsFieldsItem.Raw, Fileforge.pdf.FormFillRequestOptionsFieldsItem>;
export declare namespace FormFillRequestOptionsFieldsItem {
    type Raw = FormFillRequestOptionsFieldsItemValue.Raw | FormFillRequestOptionsFieldsItemChecked.Raw | FormFillRequestOptionsFieldsItemTwo.Raw | FormFillRequestOptionsFieldsItemThree.Raw;
}
