import { date } from "@fileforge/client/dist/esm/client/codegen/core/schemas";
import { Footnote, PageBottom, Tailwind } from "@fileforge/react-print";
import React from 'react';

export default function Raport({data}) {
    let nama = data.nama;
            ...
            <div>
                <div className="flex justify-between items-end pb-4 mb-8">
                    <div>
                        ...
                        <p className="text-xs">Senin, 15 Juli 2024</p>
                    </div>
                    <svg
                ...
                <div className="text-right">
                    <p className="p-0 mb-1">
                        <b>Dinas Kesehatan Kota Semarang</b>
                    </p>
                    <p className="p-0 mb-1">Jl. Pandanaran</p>
                    <p className="p-0 mb-1">Semarang Tengah</p>
                    <p className="p-0 mb-1">Jawa Tengah</p>
                    <p className="p-0 mb-1">Indonesia</p>
                </div>
                ...
                <div>
                    ...
                    <p className="p-0 mb-1">{nama}</p>
                    <p className="p-0 mb-1">{alamat}</p>
                    <p className="p-0 mb-1">+62{no_hp}</p>
                    <p className="p-0 mb-1">Indonesia</p>
                </div>
                ...
                <p className="p-0 leading-5">
                    Terima kasih karena telah melakukan pemeriksaan pada Puskesmas Poncol
                    <Footnote>Semoga sehat selalu ya!</Footnote>uj
                </p>
