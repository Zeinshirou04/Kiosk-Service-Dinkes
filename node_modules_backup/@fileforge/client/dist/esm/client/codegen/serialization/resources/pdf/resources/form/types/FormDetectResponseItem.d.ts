...
export declare const FormDetectResponseItem: core.serialization.Schema<serializers.pdf.FormDetectResponseItem.Raw, Fileforge.pdf.FormDetectResponseItem>;
export declare namespace FormDetectResponseItem {
    type Raw = FormDetectResponseItemIsChecked.Raw | FormDetectResponseItemIsEditable.Raw | FormDetectResponseItemIsMutuallyExclusive.Raw | FormDetectResponseItemIsCombed.Raw | FormDetectResponseItemType.Raw;
}
