...
export class Form {
    ...
    async detect(file, request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: urlJoin((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/form/detect/"),
            method: "POST",
            headers: {
    ...
    async mark(file, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: urlJoin((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/form/mark/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
    ...
    async fill(file, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: urlJoin((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/form/fill/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
