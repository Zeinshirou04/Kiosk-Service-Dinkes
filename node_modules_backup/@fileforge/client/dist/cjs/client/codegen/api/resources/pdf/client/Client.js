...
const Client_1 = require("../resources/form/client/Client");
/**
 * PDF operations
 */
class Pdf {
    ...
    async fromDocx(file, request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/docx/"),
            method: "POST",
            headers: {
    ...
    async generate(files, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/generate/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                ...
                case 500:
                    throw new Fileforge.InternalServerError(_response.error.body);
                case 502:
                    throw new Fileforge.BadGatewayError(await serializers.ErrorSchema.parseOrThrow(_response.error.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        breadcrumbsPrefix: ["response"],
    ...
    async merge(files, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/merge/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
    ...
    async split(file, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/split/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
    ...
    async extract(file, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/extract/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
    ...
    async insert(files, request, requestOptions) {
        ...
        const _maybeEncodedRequest = _request.getRequest();
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ?? environments.FileforgeEnvironment.Default, "pdf/insert/"),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
                "X-Fern-Runtime": core.RUNTIME.type,
    ...
    _form;
    get form() {
        return (this._form ??= new Client_1.Form(this._options));
    }
